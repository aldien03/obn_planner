...
SOURCES = \
	__init__.py \
	Map Catalog.py Map Catalog_dockwidget.py

PLUGINNAME = Map Catalog

PY_FILES = \
	__init__.py \
	Map Catalog.py Map Catalog_dockwidget.py

UI_FILES = Map Catalog_dockwidget_base.ui
...
QGISDIR=C:\Users\chnav\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
